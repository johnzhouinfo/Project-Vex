    ...
    <nav class="navbar navbar-light align-items-start sidebar sidebar-dark accordion"
        ...
        <div class="container-fluid d-flex flex-column p-0">
            ...
            <ul class="nav navbar-nav text-light" id="accordionSidebar">
                <li class="nav-item" role="presentation"><a class="nav-link" href="user_profile.php"
                                                            style="color: rgb(31,31,31);"><i class="fas fa-user"
                                                                                             style="font-size: 14px;color: rgb(31,31,31);"></i><span
                                style="font-size: 14px;">Profile</span></a><a class="nav-link active"
                                                                              href="user_project.php"
                        ...
                        <div class="table-responsive table mt-2" id="dataTable" role="grid"
                            ...
                            <table class="table dataTable my-0" id="dataTable">
                                ...
                                <tr class="text-center">
                                    <th style="font-size: 14px;">Project ID</th>
                                    <th style="font-size: 14px;">Project Name</th>
                                    <th style="font-size: 14px;">Created Time</th>
            ...
            success: function (data) {
                ...
                if (dataResult.status) {
                    ...
                    for (var i = 0; i < dataResult.project.length; i++) {
                        ...
                        var html = "<tr>" +
                            "<td>" + dataResult.project[i].product_id + "</td>" +
                            "<td><a href='#' onclick=\"window.open('../editor.php?id=" + dataResult.project[i].product_id + "')\">" + dataResult.project[i].product_name + "</a></td>" +
                            "<td>" + dataResult.project[i].create_time + "</td>" +
                            "<td><label class=\"switch\" style=\"margin-top: 2px;\">\n" +
                            ...
                            "</td>" +
                            "<td><div class='btn-group' role='group' style='font-size: 12px;'>" +
                            "<button class=\"btn\" data-toggle=\"tooltip\" data-placement=\"top\" data-bs-hover-animate=\"pulse\" onclick='changePageName(event)' product-id='" + dataResult.project[i].product_id + "' product-name='" + dataResult.project[i].product_name.trim() + "' type=\"button\" style=\"font-size: 12px;\" title=\"Rename\"><i class=\"fas fa-edit\" product-id='" + dataResult.project[i].product_id + "' product-name='" + dataResult.project[i].product_name.trim() + "' ></i></button>" +
                            "<button class='btn' data-toggle=\"tooltip\" data-placement=\"top\" data-bs-hover-animate=\"pulse\" title='Delete' id='delete_pg_btn_usr_pg' type='button' onclick='deleteProduct(event)' product-id='" + dataResult.project[i].product_id + "' style='font-size: 12px;'><i class='fa fa-remove' product-id='" + dataResult.project[i].product_id + "'  title='Delete'></i></button></div></td>" +
                            "</tr>";
                        $("#project-list").append(html);
                    }
