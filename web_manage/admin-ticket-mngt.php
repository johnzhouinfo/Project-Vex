                            ...
                            <div class="col-md-6">
                                <div class="text-md-right dataTables_filter" id="dataTable_filter"><label>
                                        <input class="border rounded-0 form-control form-control-sm" type="search"
                                               id="search-field" aria-controls="dataTable" placeholder="Search tickets"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <nav class="d-lg-flex justify-content-lg-end dataTables_paginate paging_simple_numbers">
                                    <ul class="pagination">
                                        <li class="page-item disabled" id="previous_tkt_btn_admin_pg"
                                            style="font-size: 14px;"><a class="page-link" href="#"
                                                                        aria-label="Previous"><span
                                                        aria-hidden="true">«</span></a></li>
                                        <li class="page-item active" style="font-size: 14px;"><a class="page-link"
                                                                                                 href="#">1</a></li>
                                        <li class="page-item" style="font-size: 14px;"><a class="page-link"
                                                                                          href="#">2</a></li>
                                        <li class="page-item" style="font-size: 14px;"><a class="page-link"
                                                                                          href="#">3</a></li>
                                        <li class="page-item" id="next_tkt_btn_admin_pg" style="font-size: 14px;"><a
